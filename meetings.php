...
<body>
    ...
    <section id="meetingPage">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mx-auto d-flex justify-content-evenly">
                    <button class="btn btn-light text-danger px-4 border-0 rounded-pill" onclick="allPost()">تمام جلسات</button>
                    <button class="btn btn-light text-danger px-5 border-0 rounded-pill" onclick="importantPost()">مهم</button>
                    <button class="btn btn-light text-danger px-5 border-0 rounded-pill" onclick="attractivePost()">جذاب</button>
                </div>
            </div>
            <div class="row mt-5" id="post-row">
